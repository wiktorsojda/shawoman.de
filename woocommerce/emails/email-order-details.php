...
<div style="margin-bottom: <?php echo $email_improvements_enabled ? '24px' : '40px'; ?>;">
	<table class="td font-family <?php echo esc_attr( $order_table_class ); ?> rounded-table" cellspacing="0" cellpadding="6" style="width: 100%;" border="0">
	...
	<?php if ( $order->get_customer_note() && $email_improvements_enabled ) { ?>
		<?php if ( $display_section_divider ) : ?>
			<hr style="border: 0; border-top: 1px solid #1E1E1E; border-top-color: rgba(30, 30, 30, 0.2); margin: 20px 0;">
		<?php endif; ?>
		<table class="td font-family <?php echo esc_attr( $order_table_class ); ?> rounded-table" cellspacing="0" cellpadding="6" style="width: 100%;" border="0" role="presentation">
