...
// Load colors.
$bg               = '#fafafa'; // $color-neutral-50
$body             = '#ffffff'; // $color-white
$base             = '#c68e7a'; // $color-primary-medium
$text             = '#252525'; // $color-neutral-900
$footer_text      = '#727272'; // $color-neutral-600
$header_alignment = $email_improvements_enabled ? ( is_rtl() ? 'right' : 'left' ) : false;
$logo_image_width = '160';
...
$safe_font_family = "'Be Vietnam Pro', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif";
...
#template_container {
	box-shadow: 1px 5px 12px 0 rgba(0, 0, 0, 0.06) !important;
	background-color: <?php echo esc_attr( $body ); ?>;
	border: 0;
