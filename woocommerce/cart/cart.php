...
<div class="container container-cart container-width-90" >
	<div class="row">
		<div class="col-md-8">
			<?php
			// Breadcrumbs and Title can go here if they're part of the page content
			?>
			<h1 class="cart-title"><?php esc_html_e('Cart', 'woocommerce'); ?></h1>
...
<tr class="woocommerce-coupon-totals coupon">
	<!-- <th></th> -->
