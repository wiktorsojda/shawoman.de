...
function display_product_faq() {
    ...
    echo '<style>
        @media (max-width: 768px) {
            .shav-product-faq { padding: 12px !important; }
            .shav-product-faq .shav-faq-header { padding: 24px 12px !important; }
            .shav-product-faq .shav-faq-content { padding: 0 12px 24px 12px !important; }
        }
    </style>';
