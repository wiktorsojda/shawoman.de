    ...
    function blendygo_render_cpt_banner()
    {
        ...
        <style>
            ...
            #blendygo-promo-banner-<?php echo $promo_id; ?> .countdown-timer-flex {
                display: flex;
                column-gap:
                    <?php echo esc_attr($g_col); ?>
                    px;
                font-family:
                    <?php echo esc_attr($f_fam); ?>
                    , sans-serif;
                height: 36px;
                line-height: normal;
                text-align: center;
            ...
            #blendygo-promo-banner-<?php echo $promo_id; ?> .countdown-wrapper {
                ...
                align-items: center;
                row-gap:
                    <?php echo esc_attr($g_row); ?>
                    px;
            }

            #blendygo-promo-banner-<?php echo $promo_id; ?> .countdown-number {
                font-weight:
                    <?php echo esc_attr($f_wei_n); ?>
                ;
                font-size:
                    <?php echo esc_attr($f_num); ?>
                    px;
            ...
            #blendygo-promo-banner-<?php echo $promo_id; ?> .countdown-label {
                font-weight:
                    <?php echo esc_attr($f_wei_l); ?>
                ;
                font-size:
                    <?php echo esc_attr($f_lbl); ?>
                    px;
            ...
            @media (min-width: 769px) {
                ...
                .cpt-timer-desk-container {
                    position: absolute;
                    top:
                        <?php echo esc_attr($t_top); ?>
                        %;
                    left:
                        <?php echo esc_attr($t_left); ?>
                        %;
            ...
            @media (max-width: 768px) {
                ...
                .cpt-timer-mob-container {
                    position: absolute;
                    top:
                        <?php echo esc_attr($t_top_m); ?>
                        %;
                    left:
                        <?php echo esc_attr($t_left_m); ?>
                        %;
                    transform: translate(-50%, -10%);
                    display: block !important;
                    width: 100%;
    ...
    function blendygo_render_cpt_product_set()
    {
        ...
        if (!$cpt_found) {
            ...
            foreach ($saved_promo_sets as $p_set) {
                if (isset($p_set['active']) && $p_set['active'] === 'no')
                    continue;
        ...
        if ( ! empty( $img ) ) {
            echo '<div class="shav-bundle__thumb" style="flex: 0 0 48%; max-width: 48%;">';
