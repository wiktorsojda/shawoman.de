            ...
            <form action="options.php" method="post" id="shav-store-settings-form">
                ...
                <div id="tab-stock" class="shav-tab-content active">
                    ...
                    <div class="shav-field-group" id="global_strip_max_wrap" style="<?php echo get_option('shav_stock_strip_mode', 'auto') === 'auto' ? 'display:block;' : 'display:none;'; ?>">
                        ...
                        <input type="number" name="shav_stock_strip_max_stock" class="shav-input-text" min="1" style="max-width: 150px;" value="<?php echo esc_attr(get_option('shav_stock_strip_max_stock', 100)); ?>">
                        <span class="shav-desc">Liczba sztuk, od której pasek liczy procent w dół. Domyślnie dla trybu Automatycznego.</span>
                    </div>
                ...
                <div id="tab-text-badges" class="shav-tab-content">
                    ...
                    <button type="button" class="button button-secondary shav-add-row" id="add-text-badge-rule">+ Dodaj nową regułę etykiety tekstowej</button>
                ...
                <!-- ZAKŁADKA 7: CHECKOUT / BUYBOX -->
                <div id="tab-checkout" class="shav-tab-content">
                    <h2>Checkout / Buybox</h2>
                    <p class="shav-desc">Ustawienia wyglądu koszyka i strony zamówienia.</p>
