...
<header class="header" id="top-menu">
    <div class="header__inner">
        ...
        <nav class="header__nav" aria-label="Główna nawigacja">
            ...
            <?php if ($showWhatsapp): ?>
                <a class="header__nav-whatsapp-mobile" href="<?php echo esc_url($whatsappUrl); ?>" target="_blank" aria-label="WhatsApp">
        ...
        <?php if ($showWhatsapp): ?>
            <div class="header__whatsapp">
                <a class="header__whatsapp-link" href="<?php echo esc_url($whatsappUrl); ?>" target="_blank" aria-label="WhatsApp">
