...
<div class="blog-index-wrapper">
    ...
    <div class="blog-hero-wrapper" style="padding: 16px; background-color: #FAFAFA; margin-bottom: 4rem;"><header class="blog-category-banner" style="border-radius: 24px; overflow: hidden; margin-bottom: 0;">
    ...
    <div class="blog-hero-wrapper" style="padding: 16px; background-color: #FAFAFA;">
    <header class="blog-hero-simple" style="border-radius: 24px; overflow: hidden; position: relative;">
        ...
        <button class="about-us-second-scroll blog-hero-scroll-btn" type="button" aria-label="Przewiń w dół" onclick="document.getElementById('blog-grid').scrollIntoView({behavior:'smooth'})" style="background: transparent; border: 0; cursor: pointer; transition: transform 0.2s ease; position: absolute; bottom: 30px; left: 50%; transform: translateX(-50%); z-index: 10;">
            <svg width="71" height="71" viewBox="0 0 71 71" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
