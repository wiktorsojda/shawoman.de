...
$title           = isset($attributes['title'])    ? $attributes['title']    : 'Kariera';
$subtitle        = isset($attributes['subtitle']) ? $attributes['subtitle'] : 'Dołącz do nas';
...
$inline_style = $backgroundImage
    ...
    : '';
?>
<div class="video-background-container-wysylka kariera-header" <?php echo $inline_style ? 'style="' . $inline_style . '"' : ''; ?>>
...
<style>
.kariera-header { height: 75vh !important; }
@media(max-width: 900px) { .kariera-header { height: 54vh !important; } }
</style>
