...
$inline_style = $backgroundImage
    ...
    : '';
?>
<section class="cechy-container cechy-image-container cechy-image-etui container" <?php echo $inline_style ? 'style="' . $inline_style . '"' : ''; ?>>
...
<section class="container mobile-cechy-container " id="etui-cechy">
