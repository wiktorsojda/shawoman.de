<?php
$title           = isset($attributes['title'])           ? $attributes['title']           : 'Technologia CutFree';
...
$inline_style = $backgroundImage
    ...
    : '';
?>
<section class="container mobile-cechy-container cechy-mobile-container-1">
...
<section class="cechy-container cechy-image-container cechy-image-1 container" <?php echo $inline_style ? 'style="' . $inline_style . '"' : ''; ?>>
    <div class="cechy-inner-wrapper">
        <div class="container--narrow2-important content-position-helper">
            <div class="text-cechy-container cechy-1">
