...
function Edit({
  ...
  const updateOption = (idx, patch) => {
    const next = options.map((o, i) => i === idx ? {
      ...o,
      ...patch
    } : o);
    setAttributes({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      try {
        ...
        if (parsed.options && Array.isArray(parsed.options)) {
          updates.options = options.map((o, i) => {
            if (parsed.options[i]) {
              var _parsed$options$i$tit, _parsed$options$i$des;
              return {
                ...o,
                title: (_parsed$options$i$tit = parsed.options[i].title) !== null && _parsed$options$i$tit !== void 0 ? _parsed$options$i$tit : o.title,
                desc: (_parsed$options$i$des = parsed.options[i].desc) !== null && _parsed$options$i$des !== void 0 ? _parsed$options$i$des : o.desc
              };
            }
            return o;
          });
    ...
    initialOpen: true
  }, options.map((opt, idx) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: idx,
    style: {
  ...
  }, "Metoda ", idx + 1), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
    label: "Nag\u0142\xF3wek metody",
    value: opt.title,
    onChange: v => updateOption(idx, {
      title: v
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextareaControl, {
    label: "Opis metody",
  ...
  }, "Wybierz obraz z biblioteki ", (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", null, "lub"), " wklej kod SVG (inline). Inline ma priorytet."), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    style: {
      display: "flex",
      gap: "8px",
      alignItems: "center",
    ...
    onSelect: media => updateOption(idx, {
      icon: media.url
    }),
    allowedTypes: ["image"],
    value: opt.icon,
  ...
  })), opt.icon && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    variant: "link",
    isDestructive: true,
    onClick: () => updateOption(idx, {
      icon: ""
    })
  }, "Usu\u0144 ikon\u0119")), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextareaControl, {
    ...
    variant: "primary",
    onClick: addOption
  }, "+ Dodaj metod\u0119 wysy\u0142ki")), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    label: "Wyr\xF3wnanie tre\u015Bci",
    value: alignment || "center",
    options: [{
      label: "Do środka (Domyślnie)",
      value: "center"
    }, {
      label: "Do lewej",
      value: "left"
    ...
    className: `metody-wysylki-textcontainer container--narrow2-important${alignClass}`
    ...
    tagName: "h2",
    className: "metody-wysylki-h2",
    value: a.subheader,
    onChange: v => setAttributes({
      subheader: v
    }),
    placeholder: "Podnag\u0142\xF3wek"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
    className: "metody-wysylki-ul"
  }, options.map((opt, idx) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: idx,
    className: "metody-wysylki-list"
  }, opt.iconSvg ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: `metody-wysylki-list-icon${grayscaleClass}`,
    ...
    }, opt.icon ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
      className: `metody-wysylki-list-icon${grayscaleClass}`,
      src: opt.icon,
      alt: "",
      style: {
    ...
    }, "Dodaj", (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("br", null), "zdj\u0119cie"))
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
    tagName: "li",
    value: opt.title,
    onChange: v => updateOption(idx, {
...
/***/ "./src/metodywysylkitext/block.json"
/*!******************************************!*\
  !*** ./src/metodywysylkitext/block.json ***!
  \******************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ourblocktheme/metodywysylkitext","title":"Metody Wysyłki Text","attributes":{"header":{"type":"string","default":"Ekspresowa wysyłka"},"description":{"type":"string","default":"Zamówienia złożone u nas wysyłamy w ciągu 24 godzin, a dostarczamy w ciągu kolejnych 24 godzin! To oznacza, że Twoje zakupy będą u Ciebie w maksymalnie 2 dni robocze!"},"subheader":{"type":"string","default":"Sprawdź nasze opcje wysyłki:"},"option1Title":{"type":"string","default":"Kurier InPost - 0zł"},"option1Desc":{"type":"string","default":"Przy zamówienieniach poniżej 100zł: 9,99zł"},"option2Title":{"type":"string","default":"Paczkomat InPost - 0zł"},"option2Desc":{"type":"string","default":"Przy zamówienieniach poniżej 100zł: 9,99zł"},"option1Icon":{"type":"string","default":""},"option1IconSvg":{"type":"string","default":""},"option2Icon":{"type":"string","default":""},"option2IconSvg":{"type":"string","default":""},"options":{"type":"array","default":[],"items":{"type":"object"}},"alignment":{"type":"string","default":"center"},"grayscaleIcons":{"type":"boolean","default":false}},"editorScript":"file:./index.js","render":"file:./render.php","supports":{"html":false,"anchor":true,"align":["wide","full"],"color":{"background":true,"text":true,"link":true,"gradients":true},"typography":{"fontSize":true,"lineHeight":true,"__experimentalFontFamily":true,"__experimentalFontWeight":true,"__experimentalFontStyle":true,"__experimentalTextTransform":true,"__experimentalLetterSpacing":true,"__experimentalTextDecoration":true},"spacing":{"padding":true,"margin":true,"blockGap":true},"__experimentalBorder":{"color":true,"radius":true,"style":true,"width":true}}}');
...
(() => {
/*!****************************************!*\
  !*** ./src/metodywysylkitext/index.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/metodywysylkitext/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./src/metodywysylkitext/edit.js");
