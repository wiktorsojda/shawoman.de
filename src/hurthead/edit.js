...
export default function Edit({ attributes, setAttributes }) {
  ...
  return (
    <div {...blockProps}>
      ...
      {videoURL && (
        <video className="video-background-wysylka" src={videoURL} autoPlay loop muted playsInline />
      )}
