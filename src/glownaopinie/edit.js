    ...
    <div {...blockProps}>
      ...
      <div className="glownaopinie__slider">
              ...
              <div key={n} className={`glownaopinie__card${isEmpty ? " glownaopinie__card--empty" : ""}`}>
                ...
                <div style={{ marginTop: 12, paddingTop: 12, borderTop: "1px dashed #ddd" }}>
                  <TextareaControl
                    ...
                    onChange={(v) => setAttributes({ [`review${n}IconSvg`]: v })}
                    rows={4}
                  />
                </div>
              </div>
        ...
        <p style={{ fontSize: 12, color: "#999", marginTop: 16 }}>
          W edytorze widzisz wszystkie 8 slotów na opinie. Na froncie aktywuje się slider — pokazuje {a.visibleCount} kart na raz, slider przewija pozostałe. Puste sloty są pomijane na froncie.
        </p>
      </div>
    </div>
  );
