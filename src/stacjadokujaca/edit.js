...
export default function Edit({ attributes, setAttributes }) {
  ...
  const blockProps = useBlockProps({ className: "video-container2", style: wrapperStyle });
  return (
    <div {...blockProps}>
      <InspectorControls>
      ...
      {!backgroundImage && <p style={{ padding: 16, textAlign: "center", color: "#999" }}>Stacja Dokująca — wrapper (treść z JS / CSS)</p>}
    </div>
  );
}
