...
export default function Edit({ attributes, setAttributes }) {
  ...
  const blockProps = useBlockProps({ className: "platnosci-container", style: wrapperStyle });
  return (
    <div {...blockProps}>
      <InspectorControls>
      ...
      {!backgroundImage && <p style={{ padding: 16, textAlign: "center", color: "#999" }}>Slider Płatności — wrapper (treść z JS / CSS)</p>}
    </div>
  );
}
